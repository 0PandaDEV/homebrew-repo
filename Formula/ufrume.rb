class Ufrume < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/0PandaDEV/ufrume/releases/download/v#{version}/ufrume-macos-arm64.zip"
      sha256 "1d45a78188bb6e7e499b7459b81a45b18f0548f2355433d8ec719666d4c17c41"
    else
      url "https://github.com/0PandaDEV/ufrume/releases/download/v#{version}/ufrume-macos-x86_64.zip"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/0PandaDEV/ufrume/releases/download/v#{version}/ufrume-linux-arm64.zip"
      sha256 "d1bf710c8bfeefaade316429b19d02f57e758099a57da267632f3d7fdfd3f155"
    else
      url "https://github.com/0PandaDEV/ufrume/releases/download/v#{version}/ufrume-linux-x86_64.zip"
